...
with open("README.md", "w") as f:
    ...
    f.write(f"# All Mods | {len(dependencies) + len(mods) + len(performance) + len(main) + len(extra)} total \n\n")
